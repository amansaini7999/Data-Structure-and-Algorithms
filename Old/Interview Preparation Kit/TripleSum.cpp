...
long triplets(vector<int> a, vector<int> b, vector<int> c) {
  ...
  long ct=0, ctA=0, ctC=0;
  set<int> A(a.begin(), a.end()), B(b.begin(), b.end()), C(c.begin(), c.end());
  vector<int> v1(A.begin(), A.end()), v2(B.begin(), B.end()), v3(C.begin(), C.end());
